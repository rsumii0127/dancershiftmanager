        ...
        <form method="POST" action="{{ route('shows.update', $show) }}">
            ...
            <div class="mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input type="text" name="show_name" class="w-auto py-2 border border-gray-300 rounded-md" id="show_name" value={{$show->show_name}}>
                </div>
                <div class="w-full flex flex-col">
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input type="date" name="start_date" id="start_date" value={{$show->start_date}}>
                </div>
                <div class="w-full flex flex-col">
                    <label for="end_date" class="font-semibold mt-4">ショー終了日</label>
                    <x-input-error :messages="$errors->get('end_date')" class="mt-2" />
                    <input type="date" name="end_date" id="end_date" value="{{$show->end_date}}">
                </div>
            </div>
